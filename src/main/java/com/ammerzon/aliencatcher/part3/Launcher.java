...
import com.ammerzon.aliencatcher.part3.helper.BlobFactory;
import com.ammerzon.aliencatcher.part3.helper.Environment;
import com.ammerzon.aliencatcher.part3.helper.LocalEnvironment;
import com.ammerzon.aliencatcher.part3.models.GameModel;
import com.ammerzon.aliencatcher.part3.views.JCatcherField;
...
public final class Launcher {
  ...
  public static void main(String[] args) {
    ...
    var gameModel = new GameModel(env, new BlobFactory(env), field);
